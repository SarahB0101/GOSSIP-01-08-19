...
20.times do
  gossip = Gossip.create(title: Faker::TvShows::BreakingBad.episode, content: Faker::TvShows::RuPaul.quote, user: User.all.sample)
  private_message = PrivateMessage.create(content: Faker::TvShows::RuPaul.quote, recipient: User.all.sample, sender:User.all.sample)
end
